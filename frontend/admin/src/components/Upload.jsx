      ...
      <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <div>
          ...
          <div
            ...
            style={{ border: `2px dashed ${drag ? "#6C63FF" : "rgba(255,255,255,0.15)"}`, borderRadius: "10px", padding: "32px", textAlign: "center", cursor: "pointer", background: drag ? "rgba(108,99,255,0.08)" : "transparent", transition: "all 0.2s" }}>
